...
const sections = [
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <h4 className="font-semibold text-gray-900">Service Fees</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-900 mt-6">Optional Add-ons</h4>
        <ul className="list-disc list-inside space-y-2 ml-4">
          <li>Cash on Delivery: €30/month</li>
          <li>AI Assistant: €10/month</li>
        </ul>

        <h4 className="font-semibold text-gray-900 mt-6">Payment Processing</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-900 mt-6">Settlement</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-900 mt-6">Taxes</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <h4 className="font-semibold text-gray-900 mt-6">By Us</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <h4 className="font-semibold text-gray-900">Our Property</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-900 mt-6">Your Content</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-900 mt-6">User-Generated Content</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <h4 className="font-semibold text-gray-900 mt-6">Total Liability</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-900 mt-6">No Warranties</h4>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <h4 className="font-semibold text-gray-900 mt-6">Resolution Process</h4>
        <p>
        ...
        <h4 className="font-semibold text-gray-900 mt-6">EU Consumer Rights</h4>
        <p>
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="bg-orange-50 p-4 rounded-lg border border-orange-100">
          ...
          <p>Email: <a href={`mailto:${CONTACT_EMAIL}`} className="text-orange-600 hover:underline">{CONTACT_EMAIL}</a></p>
