...
const sections = [
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <h4 className="font-semibold text-white mt-6">Information You Provide</h4>
        ...
        <h4 className="font-semibold text-white mt-6">Automatically Collected Information</h4>
        <ul className="list-disc list-inside space-y-2 ml-4">
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          ...
          <a href="/cookies" className="text-[#FF7A00] hover:underline">
            Cookie Policy
          </a>.
        </p>
      </div>
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          ...
          <a href={`mailto:${PRIVACY_EMAIL}`} className="text-[#FF7A00] hover:underline">
            {PRIVACY_EMAIL}
          </a>.
        </p>
      </div>
